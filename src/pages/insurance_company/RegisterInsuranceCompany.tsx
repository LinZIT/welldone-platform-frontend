...
export const RegisterInsuranceCompany: FC = () => {

    /**
     * Opciones del menu de navegacion superior
     */
    const options: Option[] = [
        { text: 'Listar Insurance Companies', path: '/insurance_companies', icon: <ListRounded /> },
    ]

    /**
     * Funcion para registrar una nueva insurance company, esta funcion se ejecuta al enviar el formulario Formik
    ...
    const onSubmit = async (
        ...
        switch (status) {
            case 200:
                toast.success('Se ha registrado la compañia de seguros')
                resetForm();
                break;
            case 400:
    ...
    return (
        <Layout>
            <DescripcionDeVista title={'Registrar Insurance Company'} description={'Registra una nueva insurance company ingresando los datos en el formulario y luego clickeando en "Registrar"!'} />
