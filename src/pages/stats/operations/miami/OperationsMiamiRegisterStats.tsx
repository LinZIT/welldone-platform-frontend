...
import { OperationsMiamiData } from "../../../../interfaces/operations-data-type";
import { Option } from "../../../../interfaces";

type InitialValues = Omit<OperationsMiamiData, 'id' | 'created_at' | 'updated_at'>
...
export const OperationsMiamiRegisterStats = () => {
    const [date, setDate] = useState<Moment>(moment());
    const options: Option[] = [
        { text: 'Menu estadisticas', icon: <PieChartRounded />, path: '/stats' },
        { text: 'Estadisticas Operations Miami', icon: <BarChartRounded />, path: '/stats/operations/miami' },
    ]
    ...
    const onSubmit = async (values: FormikValues, resetForm: (nextState?: Partial<FormikState<InitialValues>> | undefined) => void) => {
        const url = `${baseUrl}/stats/operations/miami`;
    ...
    return (
        ...
        <Layout>
            <DescripcionDeVista title={"Agregar estadisticas"} description={"Crear nuevo registro de estadisticas del departamento Operations Miami"} />
