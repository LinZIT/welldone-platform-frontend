...
type InitialValues = Omit<OperationsOrlandoData, 'id' | 'created_at' | 'updated_at' | 'closing_date' | 'observations'>

interface DataProps {
    data: OperationsOrlandoData;
}
export const TableData = ({ data }: DataProps) => {
    ...
    const [info, setInfo] = useState<OperationsOrlandoData>(data);
    ...
    const onSubmit = async () => {
        const url = `/stats/operations/orlando/${data.id}`;
