...
type InitialValues = Omit<OperationsMiamiData, 'id' | 'created_at' | 'updated_at' | 'closing_date' | 'observations'>


interface DataProps {
    data: OperationsMiamiData;
}
export const TableData = ({ data }: DataProps) => {
    ...
    const [info, setInfo] = useState<OperationsMiamiData>(data);
    ...
    const onSubmit = async () => {
        const url = `/stats/operations/miami/${data.id}`;
